...
# chmod 400 keys/*
# Install Roles
/usr/local/bin/ansible-galaxy install geerlingguy.java -p roles/
/usr/local/bin/ansible-galaxy install gantsign.golang -p roles/
/usr/local/bin/ansible-galaxy install davidwittman.redis -p roles/
